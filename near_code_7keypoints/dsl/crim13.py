...
CRIM13_FEATURE_SUBSETS = {
    ...
    "position_m1": torch.LongTensor([0, 1]),
    "position_m2": torch.LongTensor([2, 3]),
...
class Crim13PositionM1Selection(AffineFeatureSelectionFunction):

    def __init__(self, input_size, output_size, num_units):
        self.full_feature_dim = CRIM13_FULL_FEATURE_DIM
        self.feature_tensor = CRIM13_FEATURE_SUBSETS["position_m1"]
        super().__init__(input_size, output_size, num_units, name="PositionM1Select")

class Crim13PositionM2Selection(AffineFeatureSelectionFunction):

    def __init__(self, input_size, output_size, num_units):
        self.full_feature_dim = CRIM13_FULL_FEATURE_DIM
        self.feature_tensor = CRIM13_FEATURE_SUBSETS["position_m2"]
        super().__init__(input_size, output_size, num_units, name="PositionM2Select")
