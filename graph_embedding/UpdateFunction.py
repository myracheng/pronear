...
class UpdateFunction(nn.Module):
    ...
    def u_duvenaud(self, h_v, m_v, opt):
        ...
        # print(parameter_mat.shape)([6, 5, 2])
        m_v = m_v[...,None]

        # print(m_v.shape)torch.Size([6, 2])
        # print(parameter_mat.shape)
        # print( torch.transpose(m_v, 1, 2).shape)
        aux = torch.bmm(parameter_mat, m_v)
    ...
    def init_duvenaud(self, params):
        ...
        print(torch.randn(len(args['deg']), args['in'], args['out']).shape)
