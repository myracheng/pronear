...
class MessageFunction(nn.Module):
    ...
    def m_mpnn(self, h_v, h_w, e_vw, opt={}):
        ...
        # print(h_v.shape)100, 4, 73])
        # print(h_w.shape)[400, 73])
        # print(e_vw.shape)[1600, 1])
        # h_w[]
        #print(h_w[..., None].shape) #[400, 73, 1])

        # h_w_rows = h_w[..., None].reshape(h_v.shape).contiguous()
        ...
        # print(torch.unsqueeze(h_w_rows,2).shape)
        # [1600, 73, 73]) torch.Size([400, 73, 1]). 1600 x 73 x 1
